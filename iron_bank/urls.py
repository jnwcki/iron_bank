...
from bankapp.views import IndexView, ProfileView, CreateAccountView, TransactionView, TransactionDetailView, SignUp
...
urlpatterns = [
    ...
    url(r'^account/create/', CreateAccountView.as_view(), name='create_account'),

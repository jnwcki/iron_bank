...
from bankapp.views import IndexView, ProfileView, MoneyView, TransactionView, TransactionDetailView, SignUp, \
    CustomerInfoForm
...
urlpatterns = [
    ...
    url(r'^create_customer/', CustomerInfoForm.as_view(), name='custinfo')
]
